...
def run(grid, goal, spath, params, printflag = False, speed = 0.1, timeout = 1000):
    ...
    while not myrobot.check_goal(goal) and N < timeout:
        ...
        # I first check whether the point has left this segement
        ...
        # I then calculete CTE by cross product
...
# --------------------------------------------------
# I am adding some graphic here to watch the 
# calculted smooth path data 
