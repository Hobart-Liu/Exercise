...
def generate_batch(batch_size, skip_window):
    ...
    for i in range(batch_size):
        ...
        for j in range(span):
            ...
            # if skip_window = 3, span = 7, span//2 = 3,
            # if j == 3, means it is in the middle of the buffer
            # this is the target word, we shall avoid
...
if __name__ == '__main__':
    ...
    with graph.as_default():
        ...
        # TODO: understanding how to properly set stddev
        ...
        # Note:
        # in general, hidden layer takes sum up of all W*X
        # if the length of input vector is not fixed, we shall take average elimated number of samples.
        # I put reference code in below, tf.reduce_mean(embed, 1)
